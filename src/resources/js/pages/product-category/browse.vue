      ...
      <vs-col vs-lg="12">
        <vs-card>
          ...
          <div>
            ...
            >
              <template slot="thead">
                <skijasi-th sort-key="name"> {{ $t("productCategories.browse.header.name") }} </skijasi-th>
                <skijasi-th sort-key="slug"> {{ $t("productCategories.browse.header.slug") }} </skijasi-th>
                <skijasi-th sort-key="children"> {{ $t("productCategories.browse.header.children") }} </skijasi-th>
                <skijasi-th sort-key="SKU"> {{ $t("productCategories.browse.header.SKU") }} </skijasi-th>
                <skijasi-th sort-key="createdAt"> {{ $t("productCategories.browse.header.createdAt") }} </skijasi-th>
                <skijasi-th sort-key="updatedAt"> {{ $t("productCategories.browse.header.updatedAt") }} </skijasi-th>
