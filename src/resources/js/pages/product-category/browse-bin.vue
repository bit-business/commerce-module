      ...
      <vs-col vs-lg="12">
        <vs-card>
          ...
          <div>
            ...
            >
              <template slot="thead">
                <skijasi-th sort-key="name"> {{ $t("productCategories.browseBin.header.name") }} </skijasi-th>
                <skijasi-th sort-key="slug"> {{ $t("productCategories.browseBin.header.slug") }} </skijasi-th>
                <skijasi-th sort-key="desc"> {{ $t("productCategories.browseBin.header.desc") }} </skijasi-th>
                <skijasi-th sort-key="SKU"> {{ $t("productCategories.browseBin.header.SKU") }} </skijasi-th>
                <skijasi-th sort-key="deletedAt"> {{ $t("productCategories.browseBin.header.deletedAt") }} </skijasi-th>
