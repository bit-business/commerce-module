      ...
      <vs-col vs-lg="12">
        <vs-card>
          ...
          <div>
            ...
            >
              <template slot="thead">
                <skijasi-th sort-key="slug"> {{ $t("payments.browse.header.slug") }} </skijasi-th>
                <skijasi-th sort-key="name"> {{ $t("payments.browse.header.name") }} </skijasi-th>
                <skijasi-th sort-key="isActive"> {{ $t("payments.browse.header.isActive") }} </skijasi-th>
