      ...
      <vs-col vs-lg="12">
        <vs-card>
          ...
          <div>
            ...
            >
              <template slot="thead">
                <skijasi-th sort-key="name"> {{ $t("userAddress.browse.header.name") }} </skijasi-th>
                <skijasi-th sort-key="email"> {{ $t("userAddress.browse.header.email") }} </skijasi-th>
                <skijasi-th sort-key="address1"> {{ $t("userAddress.browse.header.address1") }} </skijasi-th>
                <skijasi-th sort-key="address2"> {{ $t("userAddress.browse.header.address2") }} </skijasi-th>
                <skijasi-th sort-key="createdAt"> {{ $t("userAddress.browse.header.createdAt") }} </skijasi-th>
                <skijasi-th sort-key="updatedAt"> {{ $t("userAddress.browse.header.updatedAt") }} </skijasi-th>
