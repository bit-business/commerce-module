      ...
      <vs-col vs-lg="12">
        <vs-card>
          ...
          <div>
            ...
            >
              <template slot="thead">
                <skijasi-th> {{ $t("product.browseBin.header.productImage") }} </skijasi-th>
                <skijasi-th sort-key="name"> {{ $t("product.browseBin.header.name") }} </skijasi-th>
                <skijasi-th sort-key="slug"> {{ $t("product.browseBin.header.slug") }} </skijasi-th>
                <skijasi-th sort-key="category"> {{ $t("product.browseBin.header.productCategoryId") }} </skijasi-th>
                <skijasi-th sort-key="deletedAt"> {{ $t("product.browseBin.header.deletedAt") }} </skijasi-th>
