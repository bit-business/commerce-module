...
Route::group(['prefix' => $api_route_prefix, 'as' => 'skijasi.', 'middleware' => [ApiRequest::class]], function () {
    Route::group(['prefix' => 'module/commerce/v1'], function () {
        ...
        Route::group(['prefix' => 'order', 'middleware' => [SkijasiAuthenticate::class]], function () {
            ...
            Route::post('/delete-order', HelperRoute::getController('OrderController@deleteOrder'))
            ->middleware(SkijasiCheckPermissions::class.':confirm_orders');
            ...
            Route::get('/totalneworders', HelperRoute::getController('OrderController@fetchNewOrdersCount'))->middleware(SkijasiCheckPermissions::class.':read_orders');
