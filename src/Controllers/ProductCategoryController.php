...
class ProductCategoryController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        try {
            $request->validate([
                'parent_id' => 'nullable|exists:NadzorServera\Skijasi\Module\Commerce\Models\ProductCategory,id',
                'name' => 'required|string|max:255',
                'slug' => 'required|string|max:255|unique:NadzorServera\Skijasi\Module\Commerce\Models\ProductCategory',
                'desc' => 'nullable|string',
                'SKU' => 'nullable|string|max:255|unique:NadzorServera\Skijasi\Module\Commerce\Models\ProductCategory',
    ...
    public function restore(Request $request)
    {
        ...
        try {
            $request->validate([
                'id' => 'required|exists:NadzorServera\Skijasi\Module\Commerce\Models\ProductCategory',
            ]);
    ...
    public function edit(Request $request)
    {
        ...
        try {
            $request->validate([
                'id' => 'required|exists:NadzorServera\Skijasi\Module\Commerce\Models\ProductCategory,id',
                'parent_id' => 'nullable|exists:NadzorServera\Skijasi\Module\Commerce\Models\ProductCategory,id',
                'name' => 'required|string|max:255',
                'desc' => 'nullable|string',
