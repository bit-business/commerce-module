...
class UserAddressController extends Controller
{
    ...
    public function read(Request $request)
    {
        try {
            $request->validate([
                'id' => 'required|exists:NadzorServera\Skijasi\Module\Commerce\Models\UserAddress',
            ]);
    ...
    public function add(Request $request)
    {
        try {
            ...
            if ($user_addresses_total < $limit) {
                ...
                DB::rollback();
                throw new Exception(__('skijasi_commerce::validation.limit_user_addresses'));
            }
    ...
    public function delete(Request $request)
    {
        try {
            $request->validate([
                'id' => 'required|exists:NadzorServera\Skijasi\Module\Commerce\Models\UserAddress,id',
            ]);
