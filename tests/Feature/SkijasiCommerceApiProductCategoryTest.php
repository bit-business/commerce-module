...
namespace NadzorServera\Skijasi\Module\Commerce\Tests\Feature;
...
class SkijasiCommerceApiProductCategoryTest extends TestCase
{
    /**
    ...
    public function testBrowseProduct()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/product', [
            'page' => 1,
            'limit' => $count_product,
    ...
    public function testBrowseBinProduct()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/product/bin', [
            'page' => 1,
    ...
    public function testReadProduct()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/product/read', [
            'id' => $product_id,
        ]);
        $response->assertSuccessful();
        $product->forceDelete();
    ...
    public function testRestoreDeletedProduct()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/product/restore', [
    ...
    public function testInsertProduct()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/product/add', [
            'product_category_id' => $product_category_id,
    ...
    public function testEditProduct()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('PUT', '/skijasi-api/module/commerce/v1/product/edit', $request_data_product);
    ...
    public function testDeleteProduct()
    {
        ...
        $product_id = $product->id;
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/product/delete', [
            'id' => $product_id,
        ]
        );
        $response->assertSuccessful();
    ...
    public function testForceDeleteProduct()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/product/force-delete', [
            'id' => $product_id,
        ]
        );
        $response->assertSuccessful();
    ...
    public function testDeleteMultipleProduct()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/product/delete-multiple', [
            'ids' =>  $join_product,
        ]);
        $response->assertSuccessful();
        $product->forceDelete();
    ...
    public function testForceDeleteMultipleProduct()
    {
        ...
        $join_product = join(',', $ids);
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/product/force-delete-multiple', [
            'ids' =>  $join_product,
        ]);
        $response->assertSuccessful();
    ...
    public function testBrowsePublicProduct()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/product/public', [
            'page' =>  1,
        ]);
        $response->assertSuccessful();
        foreach ($products as $key => $product) {
    ...
    public function testReadPublicProduct()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/product/public/read', [
            'slug' => $product->slug,
        ]);
        $response->assertSuccessful();
        $product->forceDelete();
