...
class SkijasiCommerceApiCartTest extends TestCase
{
    /**
    ...
    public function testBrowseCart()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/cart', [
            'page' => 1,
            'limit' => $cart_count,
        ]);
    ...
    public function testReadCart()
    {
        ...
        $cart_id = $cart->id;
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/cart/read', [
            'id' => $cart_id,
        ]);
        $response->assertSuccessful();
        $cart->forceDelete();
    ...
    public function testBrowseCartPublic()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/cart/public');
        $response->assertSuccessful();
    ...
    public function testInsertCartPublic()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/cart/public/add', [
    ...
    public function testEditCartPublic()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('PUT', '/skijasi-api/module/commerce/v1/cart/public/edit', $request_cart);
        $response->assertSuccessful();
        $data_cart = Cart::find($cart_id);
        $this->assertNotEmpty($data_cart);
    ...
    public function testDeleteCartPublic()
    {
        ...
        $cart_id = $cart->id;
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/cart/public/delete', [
            'id' => $cart_id,
        ]);
        $response->assertSuccessful();
        $product_detail->forceDelete();
