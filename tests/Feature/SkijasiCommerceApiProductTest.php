...
class SkijasiCommerceApiProductTest extends TestCase
{
    ...
    {
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/product-category/add', [
            'name' => 'test',
            'slug' => Str::uuid(),
            'desc' => 'decription',
            'SKU'  => Str::uuid(),
    ...
    public function testEditProductCategory()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('PUT', '/skijasi-api/module/commerce/v1/product-category/edit', $request_data);
        $response->assertSuccessful();
    ...
    public function testReadProductCategory()
    {
        ...
        $product_category_id = $model->id;
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/product-category/read', [
            'id' =>  $product_category_id,
        ]);
        $response->assertSuccessful();
    ...
    public function testBrowseProductCategory()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/product-category');
        $response->assertSuccessful();
    ...
    public function testDeleteProductCategory()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/product-category/delete', [
            'id' =>  $product_category_id,
        ]);
        $response->assertSuccessful();
    ...
    public function testDeleteMultipleProductCategory()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/product-category/delete-multiple', [
    ...
    public function testForceDeleteProductCategory()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/product-category/force-delete', [
            'id' =>  $product_category_id,
        ]);
        $response->assertSuccessful();
    ...
    public function testBrowseBinProductCategory()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/product-category/bin', [
            'page' => 1,
