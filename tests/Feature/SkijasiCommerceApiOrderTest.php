...
class SkijasiCommerceApiOrderTest extends TestCase
{
    /**
    ...
    public function testBrowseOrder()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/order', [
            'page' => 1,
            'limit' => $count_order,
        ]);
    ...
    public function testReadOrder()
    {
        ...
        $order_id = $order->id;
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/order/read', [
            'id' => $order_id,
        ]);
        $response->assertSuccessful();
        $order->forceDelete();
    ...
    public function testConfirmOrder()
    {
        ...
        $order_id = $order->id;
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/order/confirm', [
            'id' => $order_id,
        ]);
        $response->assertSuccessful();
        $order->forceDelete();
    ...
    public function testRejectOrder()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/order/reject', [
            'id' => $order_id,
    ...
    public function testShipOrder()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/order/ship', [
            'id' => $order_id,
    ...
    public function testDoneOrder()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/order/done', [
            'id' => $order_id,
        ]);
    ...
    public function testBrowseOrderPublic()
    {
        ...
        $join_id = join(',', $ids);
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/order/public');
        $response->assertSuccessful();
    ...
    public function testPayOrderPublic()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/order/public/pay', $request_order);
        $response->assertSuccessful();
    }
