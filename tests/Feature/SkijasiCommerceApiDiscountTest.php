...
class SkijasiCommerceApiDiscountTest extends TestCase
{
    ...
    public function testBrowseDiscount()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/discount', [
            'page' => 1,
    ...
    public function testBrowseBinDiscount()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/discount/bin', [
            'page' => 1,
    ...
    public function testReadDiscount()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('GET', '/skijasi-api/module/commerce/v1/discount/read', [
            'id' => $discount_id,
        ]);
        $response->assertSuccessful();
    ...
    {
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/discount/add', [
    ...
    public function testEditDiscount()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('PUT', '/skijasi-api/module/commerce/v1/discount/edit', $request_discount);
        $response->assertSuccessful();
    ...
    public function testDeleteDiscount()
    {
        ...
        $discount_id = $discount->id;
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/discount/delete', [
            'id' => $discount_id,
        ]);
        $response->assertSuccessful();
        $discount->forceDelete();
    ...
    public function testForceDeleteDiscount()
    {
        ...
        $discount_id = $discount->id;
        $discount->delete();
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/discount/force-delete', [
            'id' => $discount_id,
        ]);
        $response->assertSuccessful();
    ...
    public function testDeleteMultipleDiscount()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/discount/delete-multiple', [
            'ids' =>  $join_discount,
        ]);
        $response->assertSuccessful();
        $discount->forceDelete();
    ...
    public function testForceDeleteMultipleDiscount()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/discount/force-delete-multiple', [
            'ids' =>  $join_discount,
        ]);
        $response->assertSuccessful();
        $history = [];
    ...
    public function testRestoreDeleteDiscount()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/discount/restore', [
    ...
    public function testRestoreMultipleDeleteDiscount()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/discount/restore-multiple', [
