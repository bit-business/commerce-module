...
class SkijasiCommerceApiProductDetailTest extends TestCase
{
    /**
    ...
    public function testInsertProductDetail()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('POST', '/skijasi-api/module/commerce/v1/product-detail/add', [
    ...
    public function testEditProductDetail()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('PUT', '/skijasi-api/module/commerce/v1/product-detail/edit', $request_product_detail);
        $response->assertSuccessful();
    ...
    public function testDeleteProductDetail()
    {
        ...
        $response = CallHelperTest::withAuthorizeBearer($this)->json('DELETE', '/skijasi-api/module/commerce/v1/product-detail/delete', [
            'id' =>  $product_detail_id,
        ]);
        $response->assertSuccessful();
